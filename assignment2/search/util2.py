...
class Stack:
    ...
    def display(self):
        "Just iterate over the entire queue and print each element."
        for item in self.list:
            print item 

    def find(self,item):
        "Are you there in the queue, item? Returns a boolean."
...
class PriorityQueue:
    ...
    def findAndRet(self,item):
        "Are you there in the queue, item? Returns the node from the queue."
        for element in self.heap:
            if element == item:
                return element
        return None
    ...
    def delItem(self,item):
        "Are you there in the queue, item? Let's delete you then. Good bye!"
        del self.heap[item]
...
def euclideanDistance( xy1, xy2 ):
    "Returns the straight-line distance between points xy1 and xy2"
    return ((xy1[1]-xy2[1])**2+(xy1[0]-xy2[0])**2)**0.5
